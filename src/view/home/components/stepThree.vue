      ...
      >
        ...
        <div class="home-upload-content">
          <Upload
            ...
            type="4"
            document-type="0007"
            not-uploaded-tip="请上传手持身份证自拍照"
            ref="upload0"
          />
        </div>
      </section>
      <section
        v-show="accountName.type == 2"
        class="home-upload"
      >
        <div class="home-upload-txt">
          开户许可证
  ...
  methods: {
    ...
    getParams() {
      let params = {
        ...
        bank_acct_name:
          this.accountName.type === 2
            ? this.accountName.openName
            : getStore('pospal_signing', true).legal_name
      };
