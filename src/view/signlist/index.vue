  ...
  <div class="sort-page c-flex-page">
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            class="sign-item__header-item"
            @click="handleRadioClick(item)"
            v-if="item.apply_status_msg === '入网成功'"
          >
        ...
        <div class="sign-item__content">
          ...
          <div
            ...
            v-if="item.fee_rate"
          >
            <div class="sign-item__row-key">申请费率</div>
            <div class="sign-item__row-value">{{ item.fee_rate }}</div>
          </div>
          <div class="sign-item__row">
    ...
    >
      <div class="c-float-btn__inner">
        <img
          src="@/assect/img/add_02@3x.png"
          class="c-float-btn__icon"
        >
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      QuerySignRecords(params).then(({ result }) => {
        this.loading = false;
